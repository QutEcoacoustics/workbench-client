...
import { emptyParam, filterParam, id, IdOr, IdParamOptional, ImmutableApi, option } from "@baw-api/api-common";
...
@Injectable()
export class AudioEventImportFileService implements ImmutableApi<AudioEventImportFile, [IdOr<AudioEventImport>]> {
  public constructor(private api: BawApiService<AudioEventImportFile>) {}

  public list(audioEventImport: IdOr<AudioEventImport>): Observable<AudioEventImportFile[]> {
    return this.api.list(AudioEventImportFile, endpoint(audioEventImport, emptyParam, emptyParam));
  }
  ...
  public filter(
    ...
    return this.api.filter(AudioEventImportFile, endpoint(audioEventImport, emptyParam, filterParam), filters);
  }

  public show(model: IdOr<AudioEventImportFile>, audioEventImport: AudioEventImport): Observable<AudioEventImportFile> {
    return this.api.show(AudioEventImportFile, endpoint(audioEventImport, model, emptyParam));
  }
  ...
  public create(model: AudioEventImportFile, audioEventImport: AudioEventImport): Observable<AudioEventImportFile> {
   ...
   */
  public dryCreate(model: AudioEventImportFile, audioEventImport: AudioEventImport) {
