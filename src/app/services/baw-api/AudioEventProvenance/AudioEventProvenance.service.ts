...
import { StandardApi, IdOr, id, option, IdParamOptional } from "@baw-api/api-common";
...
@Injectable()
export class AudioEventProvenanceService implements StandardApi<AudioEventProvenance> {
  ...
  public filter(_filters: Filters<AudioEventProvenance>): Observable<AudioEventProvenance[]> {
    return of([mockAudioEventProvenance]);
  ...
  public show(_model: IdOr<AudioEventProvenance>): Observable<AudioEventProvenance> {
    return of(mockAudioEventProvenance);
  ...
  public destroy(_model: IdOr<AudioEventProvenance>): Observable<void | AudioEventProvenance> {
    return of();
    // return this.api.destroy(endpoint(model, emptyParam));
  }
}

export const audioEventProvenanceResolvers = new Resolvers<AudioEventProvenance, [IdOr<AudioEventProvenance>]>(
  [AudioEventProvenanceService],
  "audioEventProvenanceId",
).create("AUDIO_EVENT_PROVENANCE");
