...
describe("AnalysisJobItemsService", (): void => {
  const createModel = () => new AnalysisJobItem(generateAnalysisJobItem({ id: 10 }));
  ...
  validateReadonlyApi(() => spec, AnalysisJobItem, baseUrl, baseUrl + "filter", baseUrl + "10", createModel, 10, 5);
});
