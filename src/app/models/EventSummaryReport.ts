...
import { CollectionIds, DateTimeTimezone, Id, Param } from "@interfaces/apiInterfaces";
...
export class EventSummaryReport extends AbstractModel<IEventSummaryReport> implements IEventSummaryReport {
  ...
  public tags?: Tag[];
  @hasMany<EventSummaryReport, AudioEventProvenance>(AUDIO_EVENT_PROVENANCE, "provenanceIds")
  ...
  public get viewUrl(): string {
    ...
    const route: string = reportMenuItems.view[reportLevel].route.toRouterLink();
    const routeParameters: string = this.generationParameters.toQueryParams().toString();
