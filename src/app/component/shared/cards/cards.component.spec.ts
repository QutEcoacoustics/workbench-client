...
describe('CardsComponent', () => {
  ...
  it('should create multiple cards', () => {
    component.cards = [{ title: 'title' }, { title: 'title' }];
    fixture.detectChanges();
  ...
  it('should create card with description', () => {
    component.cards = [{ title: 'title', description: 'description' }];
    fixture.detectChanges();
  ...
  it('should create card with link', () => {
    component.cards = [{ title: 'title', link: 'https://link/' }];
    fixture.detectChanges();
  ...
  it('should create multiple cards in correct order', () => {
    component.cards = [{ title: 'title1' }, { title: 'title2' }];
    fixture.detectChanges();
  ...
  it('should create single image card', () => {
    component.cards = [{ title: 'title', image: { url: 'image', alt: 'alt' } }];
    fixture.detectChanges();
