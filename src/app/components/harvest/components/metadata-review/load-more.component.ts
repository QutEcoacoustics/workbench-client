...
@Component({
  ...
  template: `
    <div class="grid-table-item load-more">
      <!-- Whitespace -->
      <baw-meta-review-whitespace [indentation]="row.parentFolder.indentation"></baw-meta-review-whitespace>
      ...
      @if (!row.isLoading) {
        <button class="btn btn-sm btn-outline-primary m-auto load-more" (click)="loadMore.emit()">
