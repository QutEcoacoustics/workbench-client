...
@Component({
  ...
  template: `
    ...
    <div class="modal-body">
      <p>Because you have changed the verification search parameters, your progress will be reset if you continue.</p>

      <p>Do you wish to reset your progress and continue with the new search parameters?</p>

      <p>
        <!-- TODO: replace with don't worry everything have been saved when we implement server persistence -->
        If you do wish to continue, make sure you download the annotations you have already done first.
      </p>

      <div class="clearfix">
        <button id="close-btn" class="btn btn-outline-primary float-start" (click)="closeModal(false)">Cancel</button>

        <button id="success-btn" class="btn btn-danger text-white float-end" (click)="closeModal(true)">
