...
const components = [DetailsComponent, EditComponent, ListComponent, NewComponent];
...
@NgModule({
  imports: [SharedModule, ProjectsModule, RouterModule.forChild([...routes, ...shallowRoutes]), ...components],
