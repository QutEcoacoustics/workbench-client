...
import { of } from "rxjs";
import { TagCompositionComponent } from "./tag-composition.component";

describe("TagCompositionComponent", () => {
  let spectator: Spectator<TagCompositionComponent>;
  let tagShowSpy: jasmine.Spy;

  const createComponent = createComponentFactory({
    component: TagCompositionComponent,
    providers: [
      {
        provide: TagsService,
        useValue: {
  ...
  it("should create", () => {
    expect(spectator.component).toBeInstanceOf(TagCompositionComponent);
  });

  it("should render an area mark", () => {
