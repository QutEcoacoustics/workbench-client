...
export type ChartData = Datasets;
...
export class ChartComponent implements AfterViewInit, OnDestroy {
  public readonly chartContainer = viewChild.required<ElementRef>("chartContainer");
   ...
   * ```
   */
  public readonly formatter = input<(item: unknown) => string>();
