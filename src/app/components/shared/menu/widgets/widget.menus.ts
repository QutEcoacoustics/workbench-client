...
export const permissionsWidgetMenuItem = new WidgetMenuItem(PermissionsShieldComponent, isLoggedInPredicate);

export const allowsOriginalDownloadWidgetMenuItem = new WidgetMenuItem(AllowsOriginalDownloadComponent);

/** A website status warning widget that warns if any part of the website is unhealthy */
export const websiteStatusWarningWidgetMenuItem = new WidgetMenuItem(WebsiteStatusWarningComponent);
