...
@Component({
  ...
  template: `
    @for (field of fields(); track field) {
      <div class="row">
        <dt class="col-sm-3 text-start text-sm-end fw-bold">{{field.props.label }}</dt>
        <baw-render-field
          class="col-sm-9"
...
export class DetailViewComponent {
  public readonly fields = input<FormlyFieldConfig[]>();
  public readonly model = input<AbstractModel>();
