...
export class DatatableSortKeyDirective implements OnChanges {
  ...
  public ngOnChanges(): void {
    // We use the square bracket notation here because the sortKey is custom
    // property that we add to ngx-datatable columns that does not
    // exist on the normal column type definition.
