...
export function generateEventSummaryReport(data?: Partial<IEventSummaryReport>): Required<IEventSummaryReport> {
  return {
    id: modelData.id(),
    ...
    graphs: {
      ...
      analysisConfidenceData: modelData.randomArray(0, 10, () =>
        Object({
